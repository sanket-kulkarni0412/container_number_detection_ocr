...
image = cv2.imread('images\storage-container-1.jpg')
...
#     text=result[i][1]
#     img=cv2.rectangle(image,top_left,bottom_right,(155,155,0),2)
#     img=cv2.putText(image, text,top_left,cv2.FONT_HERSHEY_COMPLEX,0.5,(155,155,0),1,cv2.LINE_AA)